...
`,vt=(t,e)=>{const i=t.startNode.parentNode,s=void 0===e?t.endNode:e.startNode,n=i.insertBefore(f(),s);i.insertBefore(f(),s);const o=new P(t.options);return o.insertAfterNode(n),o},bt=(t,e)=>(t.setValue(e),t.commit(),t),xt=(t,e,i)=>{const n=t.startNode.parentNode,o=i?i.startNode:t.endNode,r=e.endNode.nextSibling;r!==o&&s(n,e.startNode,r,o)},_t=t=>{n(t.startNode.parentNode,t.startNode,t.endNode.nextSibling)},wt=(t,e,i)=>{const s=new Map;for(let n=e;n<=i;n++)s.set(t[n],n);return s},St=new WeakMap,Pt=new WeakMap,Ct=(e=>(...i)=>{const s=e(...i);return t.set(s,!0),s})((t,e,i)=>{let s;return void 0===i?i=e:void 0!==e&&(s=e),e=>{if(!(e instanceof P))throw new Error("repeat can only be used in text bindings");const n=St.get(e)||[],o=Pt.get(e)||[],r=[],a=[],l=[];let c,h,d=0;for(const e of t)l[d]=s?s(e,d):d,a[d]=i(e,d),d++;let p=0,u=n.length-1,f=0,g=a.length-1;for(;p<=u&&f<=g;)if(null===n[p])p++;else if(null===n[u])u--;else if(o[p]===l[f])r[f]=bt(n[p],a[f]),p++,f++;else if(o[u]===l[g])r[g]=bt(n[u],a[g]),u--,g--;else if(o[p]===l[g])r[g]=bt(n[p],a[g]),xt(e,n[p],r[g+1]),p++,g--;else if(o[u]===l[f])r[f]=bt(n[u],a[f]),xt(e,n[u],n[p]),u--,f++;else if(void 0===c&&(c=wt(l,f,g),h=wt(o,p,u)),c.has(o[p]))if(c.has(o[u])){const t=h.get(l[f]),i=void 0!==t?n[t]:null;if(null===i){const t=vt(e,n[p]);bt(t,a[f]),r[f]=t}else r[f]=bt(i,a[f]),xt(e,i,n[p]),n[t]=null;f++}else _t(n[u]),u--;else _t(n[p]),p++;for(;f<=g;){const t=vt(e,r[g+1]);bt(t,a[f]),r[f++]=t}for(;p<=u;){const t=n[p++];null!==t&&_t(t)}St.set(e,r),Pt.set(e,l)}});class kt{constructor(t){this.id=-1,this.nativePointer=t,this.pageX=t.pageX,this.pageY=t.pageY,this.clientX=t.clientX,this.clientY=t.clientY,self.Touch&&t instanceof Touch?this.id=t.identifier:Et(t)&&(this.id=t.pointerId)}getCoalesced(){return"getCoalescedEvents"in this.nativePointer?this.nativePointer.getCoalescedEvents().map(t=>new kt(t)):[this]}}const Et=t=>self.PointerEvent&&t instanceof PointerEvent,$t=()=>{};class At{constructor(t,e){this._element=t,this.startPointers=[],this.currentPointers=[];const{start:i=(()=>!0),move:s=$t,end:n=$t}=e;this._startCallback=i,this._moveCallback=s,this._endCallback=n,this._pointerStart=this._pointerStart.bind(this),this._touchStart=this._touchStart.bind(this),this._move=this._move.bind(this),this._triggerPointerEnd=this._triggerPointerEnd.bind(this),this._pointerEnd=this._pointerEnd.bind(this),this._touchEnd=this._touchEnd.bind(this),self.PointerEvent?this._element.addEventListener("pointerdown",this._pointerStart):(this._element.addEventListener("mousedown",this._pointerStart),this._element.addEventListener("touchstart",this._touchStart),this._element.addEventListener("touchmove",this._move),this._element.addEventListener("touchend",this._touchEnd))}_triggerPointerStart(t,e){return!!this._startCallback(t,e)&&(this.currentPointers.push(t),this.startPointers.push(t),!0)}_pointerStart(t){0===t.button&&this._triggerPointerStart(new kt(t),t)&&(Et(t)?(this._element.setPointerCapture(t.pointerId),this._element.addEventListener("pointermove",this._move),this._element.addEventListener("pointerup",this._pointerEnd)):(window.addEventListener("mousemove",this._move),window.addEventListener("mouseup",this._pointerEnd)))}_touchStart(t){for(const e of Array.from(t.changedTouches))this._triggerPointerStart(new kt(e),t)}_move(t){const e=this.currentPointers.slice(),i="changedTouches"in t?Array.from(t.changedTouches).map(t=>new kt(t)):[new kt(t)],s=[];for(const t of i){const e=this.currentPointers.findIndex(e=>e.id===t.id);-1!==e&&(s.push(t),this.currentPointers[e]=t)}0!==s.length&&this._moveCallback(e,s,t)}_triggerPointerEnd(t,e){const i=this.currentPointers.findIndex(e=>e.id===t.id);return-1!==i&&(this.currentPointers.splice(i,1),this.startPointers.splice(i,1),this._endCallback(t,e),!0)}_pointerEnd(t){if(this._triggerPointerEnd(new kt(t),t))if(Et(t)){if(this.currentPointers.length)return;this._element.removeEventListener("pointermove",this._move),this._element.removeEventListener("pointerup",this._pointerEnd)}else window.removeEventListener("mousemove",this._move),window.removeEventListener("mouseup",this._pointerEnd)}_touchEnd(t){for(const e of Array.from(t.changedTouches))this._triggerPointerEnd(new kt(e),t)}}var jt=function(t,e,i,s){var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,s);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r},Nt=function(t,e){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(t,e)};const Mt="http://www.w3.org/2000/svg";let Tt=class extends yt{constructor(){super(...arguments),this.width=520,this.height=200,this.filler="",this.handles=[],this.cells=[],this.cellSize=20,this.cols=0,this.rows=0}render(){return z`
    <style>
      :host {
        display: block;
        margin: 0 auto;
    ...
    `}toggle(){this.checked=!this.checked,function(t,e,i,s=!0,n=!0){if(e){const o={bubbles:"boolean"!=typeof s||s,composed:"boolean"!=typeof n||n};i&&(o.detail=i);const r=window.SlickCustomEvent||CustomEvent;t.dispatchEvent(new r(e,o))}}(this,"change",{checked:this.checked})}};Rt([at({type:Boolean}),zt("design:type",Object)],Ot.prototype,"checked",void 0),Ot=Rt([nt("soso-switch")],Ot);var Vt=function(t,e,i,s){var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,s);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r},Lt=function(t,e){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(t,e)};let Ut=class extends yt{constructor(){super(...arguments),this.emojify=!1,this.points=[]}static get styles(){return mt}render(){return z`
    <style>
      :host {
        display: block;
